    ...
    <form action="{{ url('/projeto/atualizarProjeto/' .$projeto->id) }}" class="mb-5" method="POST">
        ...
        <div class="row">
            <div class="col-md-6 form-group mb-3">
                ...
                <input type="text" class="form-control" name="responsavel" value="{{ $projeto->responsavel }}">
            </div>
            <div class="col-md-6 form-group mb-3">
        ...
        <div class="row">
            <div class="col-md-6 form-group mb-3">
                ...
                <input type="date" class="form-control" name="data_fechamento" value="{{ $projeto->data_fechamento }}">
            </div>
            <div class="col-md-6 form-group mb-3">
