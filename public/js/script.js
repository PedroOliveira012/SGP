...
//     var valor_progresso = document.getElementById('barra').value
//     var button = document.getElementById(valor_progresso)
//     console.log(valor_progresso, button)
//     button.classList.add('progress-button-checked')
//     console.log(valor_progresso, button)
//     if (valor_progresso > button){
//         for(i = 6; i > button; i--){
//             button.classList.remove('progress-button-checked')
//         }
//     }else{
//         for(i = 0; i < button; i++){
//             button.classList.add('progress-button-checked')
